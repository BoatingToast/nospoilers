...
export default function TasteSummary({ scores }: { scores: DNAScores }) {
  ...
  return (
    <div className="bg-ns-surface border border-ns-border rounded-2xl px-6 py-5 flex items-start gap-4">
      <div className="w-8 h-8 rounded-full bg-ns-secondary/10 border border-ns-secondary/20 flex items-center justify-center flex-shrink-0 mt-0.5">
        <svg width="14" height="14" fill="none" stroke="rgb(var(--ns-secondary))" strokeWidth="2" viewBox="0 0 24 24">
