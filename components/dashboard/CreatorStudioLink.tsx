...
export default function CreatorStudioLink() {
  return (
    ...
    >
      <span className="flex h-9 w-9 flex-shrink-0 items-center justify-center rounded-lg bg-ns-secondary/10 text-ns-secondary">
      ...
      <ArrowRightIcon size={14} className="ml-auto text-ns-muted transition-transform group-hover:translate-x-0.5 group-hover:text-ns-secondary" />
    </Link>
  )
}
