        ...
        {collections.length === 0 ? (
          <div className="border border-dashed border-ns-border rounded-2xl p-16 text-center">
            ...
            <Link href="/collections/new"
              className="inline-block mt-4 px-4 py-2 bg-ns-secondary text-ns-secondary-foreground rounded-xl text-sm font-body font-medium hover:bg-ns-secondary/90 transition-colors">
